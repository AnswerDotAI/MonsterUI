...
# %% auto #0
__all__ = ['Textarea', 'franken_class_map', 'spy_js', 'spy_scrolling', 'TextT', 'TextPresets', 'CodeSpan', 'CodeBlock', 'H1',
           'H2', 'H3', 'H4', 'H5', 'H6', 'Subtitle', 'Q', 'Em', 'Strong', 'I', 'Small', 'Mark', 'Del', 'Ins', 'Sub',
           'Sup', 'Blockquote', 'Caption', 'Cite', 'Time', 'Address', 'Abbr', 'Dfn', 'Kbd', 'Samp', 'Var', 'Figure',
           'Details', 'Summary', 'Data', 'Meter', 'S', 'U', 'Output', 'PicSumImg', 'AccordionItem', 'Accordion',
           'ButtonT', 'Button', 'ContainerT', 'BackgroundT', 'Container', 'Titled', 'DividerT', 'Divider',
           'DividerSplit', 'DividerLine', 'Article', 'ArticleTitle', 'ArticleMeta', 'SectionT', 'Section', 'Form',
           'Fieldset', 'Legend', 'Input', 'Radio', 'CheckboxX', 'Range', 'TextArea', 'Switch', 'Upload', 'UploadZone',
           'FormLabel', 'LabelT', 'Label', 'UkFormSection', 'GenericLabelInput', 'LabelInput', 'LabelTextArea',
           'LabelSwitch', 'LabelRadio', 'LabelCheckboxX', 'Options', 'Select', 'LabelSelect', 'LabelRange', 'AT',
...
# %% ../nbs/02_franken.ipynb #e40a61ff
Textarea = TextArea

# %% ../nbs/02_franken.ipynb #a6d644ea
...
# %% ../nbs/02_franken.ipynb #42137142
spy_js = r'''
const slug = (s) => s.toLowerCase().replace(/[^a-z0-9\s-]/g, '').replace(/\s+/g, '-').replace(/-+/g, '-');
const frag = document.createDocumentFragment();

document.querySelector('%s').querySelectorAll('%s').forEach((h,i) => {
...
document.getElementById('%s').append(frag);
'''

spy_scrolling = '''
document.body.addEventListener('active', ({detail}) => {
    const target = detail[1];
    const {y,height} = target.getBoundingClientRect();
    if (y > height && y < innerHeight-height) return;
    requestAnimationFrame(() => target.scrollIntoView({block: 'center',container: 'nearest'}));
}, {passive: true})
'''

# %% ../nbs/02_franken.ipynb #9b5d9195
def ScrollSpy(headings=[1,2,3,4,5],       # Heading levels to map section/links from
              ...
              nav_id:str='scrollspy-nav', # ID given to the containing Ul component 
              smooth_scroll:bool=False,   # Enable smooth-scrolling to headings
              auto_scroll:bool=False,     # Scroll active links into view if they're not in the viewport
              cls:str='',
              **kwargs
              )->FT:
    ...
    if auto_scroll: js+=spy_scrolling
    nav_args = f'closest: li;offset: {offset};scroll: {str(smooth_scroll).lower()};'
    return Ul(Script(Safe(js), type='module'), data_uk_scrollspy_nav=nav_args,
                      id=nav_id, cls=f'uk-nav uk-nav-default {cls}', **kwargs)

# %% ../nbs/02_franken.ipynb #ebfb6fa9
